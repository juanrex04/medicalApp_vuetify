    ...
    <v-layout row>
          ...
          <v-container>
            ...
            <v-flex>
              <v-card class="ma-5 text-center mt-12" shaped elevation="10">
                ...
                <v-card-title class="layout justify-center">Juan Restrepo</v-card-title>
                <v-card-subtitle class="layout justify-center">25 year, Santiago de Cali, <br> April, 24/2000</v-card-subtitle>
                <v-list>
                  <v-list-item>
                  ...
                  <v-list-item class="mt-n5">
                    ...
                    <v-list-item-subtitle>171 cm</v-list-item-subtitle>
                ...
                <v-list two-line subheader>
                  <v-list-item>
                    ...
                    <v-list-item-content class="ml-n5">
                      ...
                      <v-list-item-subtitle>Hospital Universitario del Valle</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                </v-list>
      ...
      <v-flex md9>
        <v-app :style="{ background: $vuetify.theme.themes.dark.background }" class="rounded">
          <v-container>
            <!--Examinations title section-->
            <v-flex>
              <v-list class="mt-5">
                <v-list-item>
                  <v-list-item-title class="cyan--text text--darken-1">Examinations</v-list-item-title>
                  <v-list-item-action>
                    <v-btn class="ma-2" tile outlined color="cyan darken-1">
                      <v-icon left>fas fa-eye</v-icon>See All</v-btn>
                  </v-list-item-action>
                </v-list-item>
              </v-list>
            </v-flex>
            <!--Examinations descriptions section-->
            <v-flex>
              <v-row no-gutters>
                <v-col cols="12" md="4">
                  <v-row>
                      ...
                      <v-list two-line subheader class="ml-n8">
                        <v-list-item>
                          <v-list-item-content>
                            ...
                            <v-list-item-subtitle>Ongoing tratement</v-list-item-subtitle>
                          </v-list-item-content>
                        </v-list-item>
                      </v-list>
                    </v-col>
            ...
            <!--Healt curve graph description section-->
            <v-flex class="mt-5">
              <v-list class="ml-5">
                <v-list-item>
